  ...
  <h1>RISK ANALYTICS BACKEND TEST(Pritesh Kanani)</h1>
    <form action="finappresp1.php" method="post">
	 ...
	 <b> Enter your money amount: </b>
	  <input type="text" name="money" onkeyup="this.value = minmax2(this.value, 0, 1000000000000000)" value= "100" />
	  
	  <br><br><br>
	  <b>Enter a date after 2005-03-01:</b>
      <input type="date" name="startdate" min="2005-01-03" max="2014-10-24" value= "2005-03-01" onchange ="show1(this.value,0,0)" ><br>
     <b> Enter a date before 2014-10-24:</b>
      <input type="date" name="enddate" min="2005-01-03" max="2014-10-24" value= "2014-10-24" onchange ="show1(0,this.value,0)"><br>
      <br><br><br>
	  ...
	  HERO (%)
	  <br>
	  <input type="range" name="points1" min="1" max="100" onchange="element(this.value,0,0);">                                                       
    <input type="text" id="outty1" value="33.33"><br>
     	  
	  MARUTI(%)<br>
	  <input type="range" name="points2" min="1" max="100" onchange="element(0,this.value,0);">                                                       
   <input type="text" id="outty2" value="33.33">
	
	Weight of Sector(0-100):
	<input type="text" name="weight1" onkeyup="this.value = minmax(this.value, 0, 100)" value="25" />
	<br>
 
	   
	  TATA(%)<br>
	  <input type="range" name="points3" min="1" max="100" onchange="element(0,0,this.value);">                                                       
    <input type="text" id="outty3" value="33.33"><br>
	...
	ICICI(%)
	  <br>
	  <input type="range" name="points4" min="1" max="100" onchange="element1(this.value,0,0);">                                                       
    <input type="text" id="outty4" value="33.33"><br>
     	  
	  IDBI(%)<br>
	  <input type="range" name="points5" min="1" max="100" onchange="element1(0,this.value,0);">                                                       
   <input type="text" id="outty5" value="33.33">
	
	Weight of Sector(0-100):
	<input type="text" name="weight2" onkeyup="this.value = minmax(this.value, 0, 100)" value="25" />
	<br>
 
	   
	  SBI(%)<br>
	  <input type="range" name="points6" min="1" max="100" onchange="element1(0,0,this.value);">                                                       
    <input type="text" id="outty6" value="33.33"><br>
	...
	BRITTANIA(%)
	  <br>
	  <input type="range" name="points7" min="1" max="100" onchange="element2(this.value,0,0);">                                                       
    <input type="text" id="outty7" value="33.33"><br>
     	  
	  DABUR(%)<br>
	  <input type="range" name="points8" min="1" max="100" onchange="element2(0,this.value,0);">                                                       
   <input type="text" id="outty8" value="33.33">
	
	Weight of Sector(0-100):
	<input type="text" name="weight3" onkeyup="this.value = minmax(this.value, 0, 100)" value="25" />
	<br>
 
	   
	  GILETTE(%)<br>
	  <input type="range" name="points9" min="1" max="100" onchange="element2(0,0,this.value);">                                                       
    <input type="text" id="outty9" value="33.33"><br>
    ...
    <input type= "checkbox" name = "IT" value = "Y"checked> <b>IT</b>
	  ...
	  HCL(%)
	  <br>
	  <input type="range" name="points10" min="1" max="100" onchange="element3(this.value,0,0);">                                                       
    <input type="text" id="outty10" value="33.33"><br>
     	  
	  INFOSYS(%)<br>
	  <input type="range" name="points11" min="1" max="100" onchange="element3(0,this.value,0);">                                                       
   <input type="text" id="outty11" value="33.33">
	
	Weight of Sector(0-100):
	<input type="text" name="weight4" onkeyup="this.value = minmax(this.value, 0, 100)" value="25" />
	<br>
 
	   
	  TCS(%)<br>
	  <input type="range" name="points12" min="1" max="100" onchange="element3(0,0,this.value);">                                                       
    <input type="text" id="outty12" value="33.33"><br>
	 ...
	 NTPC(%)
	  <br>
	  <input type="range" name="points13" min="1" max="100" onchange="element4(this.value,0,0);">                                                       
    <input type="text" id="outty13" value="33.33"><br>
     	  
	  RELIANCE(%)<br>
	  <input type="range" name="points14" min="1" max="100" onchange="element4(0,this.value,0);">                                                       
   <input type="text" id="outty14" value="33.33">
	
	Weight of Sector(0-100):
	<input type="text" name="weight5" onkeyup="this.value = minmax(this.value, 0, 100)" value="25" />
	<br>
 
	   
	  TATA POWER(%)<br>
	  <input type="range" name="points15" min="1" max="100" onchange="element4(0,0,this.value);">                                                       
    <input type="text" id="outty15" value="33.33"><br>
      ...
      <input type="range" min= "3" max = "300" name="rebalance"  value="15" onchange="show(0,0,this.value)"/>
	  <input type="text" id="outty16" value="5 repeats"><br>
	  <br> 
